        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 text-warning">MoneyLovers</h5>
                    <p>Here we are the MoneyLovers to support you for accomplish your dessire by selling high
                        quality products.</p>
                </div>
                ...
                <p><i class="bi bi-envelope-fill"></i> MoneyLovers@gmail.com</p>
                ...
                <div class="col-12 col-lg-4 mx-auto mt-2">
                    <p>Copyright &copy;2022 MoneyLovers All Right Reserved</p>
                </div>
            </div>
        </div>
