                            ...
                            <div class="row">
                                ...
                                <div class="border border-1 rounded-2 border-dark col-10 offset-1 mb-4">
                                    ...
                                    if (!$user_data->num_rows == 0) {
                                        ...
                                        $order = Database::search("SELECT order.id, gig.title, order.delivered_time, gig.user_details_id FROM gig INNER JOIN `order` ON gig.id =`order`.gigId INNER JOIN user ON user.id =`order`.user_id
                                    INNER JOIN user_details ON user_details.user_id=user.id WHERE `order`.`user_id`='" . $user_details["id"] . "' AND  `order`.`orderStatus_id`='2'");
                                    ...
                                    ?>
                                            ...
                                            <div class="col-12 mt-3 mb-2">
                                                <div class="row text-center">
                                                    ...
                                                    <div class="col-6 col-lg-2 bg-light pt-2 pb-2">
                                                        <a href="#"> <button class="fw-bold text-black-50 btn border border-2 ">Upload Files</button></a>
                                                    </div>
                                                    ...
                                                    <div class="col-6 col-lg-2 bg-light pt-2 pb-2">
                                                        <a href="#"> <button class="fw-bold text-black-50 btn btn-outline-danger" onclick="cancelOrder(<?php echo $order_data['id']; ?>)">Cancel order</button></a>
                                                    </div>
