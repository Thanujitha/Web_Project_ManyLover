...
<head>
    <title>Freelance | Late Orders</title>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-12 shadow_div_box container-fluid mt-5">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <span class="h3 text-dark fw-bold m-3">LATE ORDERS</span>
                                ...
                                <div class="border border-1 rounded-2 border-dark col-10 offset-1 mb-4">
                                    ...
                                    INNER JOIN user_details ON user_details.user_id=user.id WHERE gig.user_details_id='" . $ud["id"] . "' AND `orderStatus_id`='3'");
                                    ...
                                    ?>
                                            ...
                                            <div class="col-12 mt-3 mb-2">
                                                <div class="row text-center">
                                                    ...
                                                    <div class="col-2 bg-light pt-2 pb-2">
                                                    <span class="fw-bold text-danger">Late</span>
                                                    </div>
